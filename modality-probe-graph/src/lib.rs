...
pub mod test_support {
    ...
    //  \ /   V
    //   4
    pub fn diamond() -> Vec<ReportLogEntry> {
        let now = Utc::now();
        ...
        vec![
            ...
            ReportLogEntry {
                ...
                persistent_epoch_counting: false,
                probe_id: probe1,
                data: LogEntryData::Event(EventId::new(1).unwrap()),
            },
            ReportLogEntry {
                session_id: SessionId(1),
                sequence_number: SequenceNumber(1),
            ...
            ReportLogEntry {
                ...
                persistent_epoch_counting: false,
                probe_id: probe3,
                data: LogEntryData::Event(EventId::new(3).unwrap()),
            },
            ReportLogEntry {
                session_id: SessionId(1),
                sequence_number: SequenceNumber(1),
...
mod test {
    ...
    #[test]
    fn sanity() {
        let report_iter = ReportIter::new(test_support::diamond().into_iter().peekable());
    ...
    fn internals() {
        ...
        let log = vec![
            ...
            ReportLogEntry {
                ...
                persistent_epoch_counting: false,
                probe_id: probe1,
                data: LogEntryData::Event(EventId::EVENT_PRODUCED_EXTERNAL_REPORT),
            },
            ReportLogEntry {
                session_id: SessionId(1),
                sequence_number: SequenceNumber(1),
        ...
        let report_iter = ReportIter::new(log.into_iter().peekable());
